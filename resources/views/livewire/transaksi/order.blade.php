    ...
    <main class="app containerw pb-5">
        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                </di @else <form autocomplete=" off" wire:submit.prevent="">
                <div class="pt-2">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @else
                        <!-- @if ($driver->aktif != 2)
                        <span class="bg-secondary px-1 rounded">Belum dikonfirmasi</span>

                        @else
                        <span class="bg-secondary px-1 rounded">Dalam Perjalanan..</span>
                        @endif -->
                        <h3>Taxi Driver</h3>
