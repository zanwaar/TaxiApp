...
<body class="bg-white">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex flex-row w-full">
            ...
            <!-- Sidebar -->
            <div class='hidden lg:flex flex-col justify-between bg-emerald-800 lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg text-white'>
                ...
                <div class='space-y-5'>
                    <h1 class="lg:text-3xl xl:text-5xl xl:leading-snug font-extrabold text-white">Jadilah Bagian dari DraivGo!</h1>
                    <p class="text-lg">Gerbang ke Petualangan Baru!</p>

                    <a href="{{ url('/') }}" class=" inline-block flex-none px-4 py-3 border-2 rounded-lg font-medium border-black bg-black text-white">DraivGo!</a>
                </div>
            ...
            <div class="flex flex-1 flex-col items-center justify-center px-10 relative">
                <div class="flex lg:hidden justify-between items-center w-full py-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <a href="{{ route('login') }}" class="underline font-medium text-[#070eff]">
                            Sudah Punya Akun?
                        </a>
                    </div>
                </div>
                <!-- Login box -->
                <div class="flex flex-1 flex-col  justify-center space-y-5 max-w-xl">
                    <livewire:mitra />
                </div>
                <!-- Login box -->
